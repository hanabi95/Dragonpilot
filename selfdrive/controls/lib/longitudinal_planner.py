...
_DP_CRUISE_MAX_V = [1.2, 1.3, 1.0, .8, .6, .4]
_DP_CRUISE_MAX_V_ECO = [0.8, 0.9, 1.0, 0.4, 0.2]
_DP_CRUISE_MAX_V_SPORT = [1.5, 1.5, 1,2, 1.0, .8, .6]
_DP_CRUISE_MAX_V_FOLLOWING = [1.2, 1.2, 1., .8, .6, .4]
_DP_CRUISE_MAX_BP = [0., 5., 10., 15., 20., 55.]
