...
_A_CRUISE_MIN_V = [-1.2, -1.0, -.67, -.5, -.30]
...
_DP_CRUISE_MIN_V_ECO = [-2.0, -2.0, -1.5, -1.0, -0.5]
...
_DP_CRUISE_MAX_V = [1.1, 1.1, .8, .65, .5]
_DP_CRUISE_MAX_V_ECO = [.8, .8, .7, 0.5, 0.3]
_DP_CRUISE_MAX_V_SPORT = [1.5, 1.5, 1,2, 1.0, .8]
_DP_CRUISE_MAX_V_FOLLOWING = [1.1, 1.1, .8, .65, .5]
